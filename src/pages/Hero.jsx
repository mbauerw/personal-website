  ...
  return (
    <div
      ...
      <div className='col-span-1 relative rounded-sm row-span-1 max-h-[900px] grid grid-cols-1 grid-rows-5 w-[95%] h-[95%] lg:min-h-[500px] px-5 justify-self-center content-center lg:justify-center justify-items-center py-5'>
        <p ref={firstRef} onMouseLeave={mouseLeave} className={`group w-1/2 xs:min-w-100 min-w-[72%] z-1 xs:text-4xl text-3xl hover:!text-5xl a6  shadow-lg shadow-black antialiased border-gray-300 border-4 border-b-gray-400 p-10 rounded-xl -mt-0 
          hover:z-10 hover:w-full hover:overflow-visible hover:-ml-6 hover:whitespace-normal hover:min-h-50 bg-gray-400 hover:bg-white
          lg:-ml-32 lg:mr-0 -ml-4 mr-4 truncate transition-all duration-1000 transform hover:-translate-y-6 ${firstHovered ? 'z-10 w-full lg:!-ml-6 overflow-visible whitespace-normal min-h-50 text-5xl -translate-y-6 bg-white' : '' }`}>
        ...
        <p className={`${boxStyle}`} onMouseEnter={mouseLeave}>
        ...
        <p onMouseEnter={mouseLeave} className='group w-1/2 xs:min-w-100 min-w-[72%] min-w-100 max-h-55 z-2  a6 xs:text-4xl text-3xl hover:!text-5xl  shadow-lg shadow-black antialiased border-gray-300 border-4 border-b-gray-400 p-10 rounded-xl
        ...
        <p onMouseEnter={mouseLeave} className='relative w-1/2 xs:min-w-100 min-w-[72%] z-3 hover:z-10 a6 xs:text-4xl text-3xl hover:!text-5xl shadow-lg shadow-black antialiased border-gray-300 border-4 border-b-gray-400 rounded-xl w-1/2 col-span-1 p-10  truncate
