  ...
  return (
    <div
      ...
      <div className='col-span-1 relative rounded-sm row-span-1 max-h-[900px] grid grid-cols-1 grid-rows-5 w-[95%] h-[95%] lg:min-h-[500px] px-5 justify-self-center content-center lg:justify-center justify-items-center py-5'>
        <p key={1} ref={firstRef} onMouseLeave={mouseLeave} onClick={() => handleParagraphClick(1)} className={`group w-1/2 xs:min-w-100 min-w-[72%] z-1 xs:text-4xl text-3xl a6  shadow-lg shadow-black antialiased border-gray-300 border-4 border-b-gray-400 p-10 rounded-xl -mt-0 
          ...
          ${selectedId === 1 ? 'z-10 !text-5xl w-full overflow-visible lg:!-ml-6 whitespace-normal min-h-50 bg-gray-400 bg-white -translate-y-6' : ''}
          lg:-ml-32 lg:mr-0 -ml-4 mr-4 truncate transition-all duration-1000 transform  ${firstHovered ? 'z-10 w-full lg:!-ml-6 overflow-visible whitespace-normal min-h-50 text-5xl -translate-y-6 bg-white' : ''}`}
          >
        ...
        <p key={2} className={`group w-1/2 xs:min-w-100 min-w-[72%] z-1 a6 xs:!text-4xl text-3xl shadow-lg shadow-black antialiased border-gray-300 border-4 border-b-gray-400 p-10 rounded-xl 
          ...
          ${selectedId === 2 ? 'z-10 !text-5xl w-full overflow-visible lg:!-ml-6 whitespace-normal md:!min-h-50 min-h-70 bg-gray-400 bg-white -translate-y-14 !p-2' : ''}`} onMouseEnter={mouseLeave} onClick={() => handleParagraphClick(2)}
          >
        ...
        <p key={3} onMouseEnter={mouseLeave} onClick={() => handleParagraphClick(3)} className={`group w-1/2 xs:min-w-100 min-w-[72%] min-w-100 max-h-55 z-2  a6 xs:text-4xl text-3xl hover:!text-5xl  shadow-lg shadow-black antialiased border-gray-300 border-4 border-b-gray-400 p-10 rounded-xl
          ...
          ${selectedId === 3 ? 'z-10 !text-5xl w-full overflow-visible lg:!-ml-6 whitespace-normal min-h-50 bg-gray-400 bg-white !-translate-y-14 ' : ''}`}>
          Loves: Family, Friends, Pets
        </p>
        <p key={4} onMouseEnter={mouseLeave} onClick={() => handleParagraphClick(4)} className={`relative w-1/2 xs:min-w-100 min-w-[72%] z-3 hover:z-10 a6  xs:text-4xl text-3xl hover:!text-4xl hover:lg:!text-5xl shadow-lg shadow-black antialiased border-gray-300 border-4 border-b-gray-400 rounded-xl w-1/2 col-span-1 p-10  truncate
        ...
        ${selectedId === 4 ? 'z-10 lg:!text-5xl text-4xl w-full overflow-visible lg:!-ml-6 whitespace-normal min-h-50 bg-gray-400 bg-white -translate-y-14 !p-2' : ''}`}>
