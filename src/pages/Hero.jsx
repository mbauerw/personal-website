...
const Hero = forwardRef(({ height=900, minHeight=900, className=""}, ref) => {
  return (
    <div 
      id="hero-wrap"
      className={`w-full flex lg:h-screen lg:flex-row lg:justify-left flex-col justify-around items-center px-5 py-5 bg-none ${className}`}
      style={{
      ...
      <div className='lg:h-full lg:w-2/5 h-1/2 w-3/4 flex flex-col justify-center content-center'>
        ...
        <p className='group p3 text-4xl bg-neutral-100 shadow-lg shadow-black antialiased border-gray-300 border-4 border-b-gray-400 p-12 rounded-xl relative -mt-8 ml-5 -mr-5 z-1 hover:z-10 '>
          Passions: <a className="group-hover:underline group-hover:text-red-600">Music</a>, learning, web development, reading
          <br />
      ...
      <div className='lg:h-3/4 lg:w-1/2 lg:border-l-1 lg:border-gray-400 h-1/2 w-full flex flex-col justify-center items-center'>
