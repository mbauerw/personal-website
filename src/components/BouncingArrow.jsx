    ...
    <div className="flex items-center justify-center h-[50vh]">
      <div className="flex flex-col justify-center items-center rounded-full h-90 w-90 transition-all duration-1000 
        ...
        <div className="h-1/2 flex justify-center items-center">
          <h1 className="text-8xl p3 font-bold text-blue-900/80 pt-16">Max Bauer</h1>
        </div>
        <div className=" h-1/2 ">
          <ArrowDown
            className="w-36 h-36 text-blue-900/80 mx-auto animate-bounce animate-duration-2000 cursor-pointer transition-colors duration-1000"
            style={{
