...
const GridBox = ({thumb, title, description, category, className, children} ) => {
  ...
  <div class="relative aspect-square bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 cursor-pointer group">
    <div class={`w-full h-[70%] bg-contain bg-center bg-no-repeat relative ${thumb} ${className}`}>
        <div class="absolute inset-0 bg-black/90 bg-opacity-40 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
    ...
    <div class="p-5 h-[30%] flex flex-col justify-center bg-gray-300/50">
